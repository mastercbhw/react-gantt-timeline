...
const Toggle = ({ toggleOpen, isOpen }) => (
  <button className={cls(styles.rtControlsButton, styles.rtControlsButtonToggle)} onClick={toggleOpen} type="button">
    <span className={styles.rtVisuallyHidden}>{isOpen ? 'Close' : 'Open'}</span>
